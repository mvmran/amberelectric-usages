...
2. Once HACS is installed, add the [amberelectric-usages repository](https://github.com/mvmran/amberelectric-usages) as a custom repository (Integration type), then you should be able to find this integration (**Amber Electric - Usages**) via HACS Integration and download it (Make sure its **Amber Electric Usages** not **Amber Electric**).
